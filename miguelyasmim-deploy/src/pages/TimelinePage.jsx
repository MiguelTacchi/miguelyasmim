...
const events = [
  { eyebrow: '23/08/2024', title: 'Dia da Despedida', desc: 'Fui completamente de penetra na sua festa de despedida. Lembro que o Caio me disse que você queria ficar comigo — no início, não acreditei que uma menina tão linda ia querer ficar com alguém que mal me conhecia. A noite rolou, a gente se beijou, e eu achei que ia ser só um ficada. Quem diria que aquilo viraria o meu grande amor.' },
  { eyebrow: '25/08/2024', title: 'Dia da Pesca', desc: 'A gente foi pescar com a galera e foram muitos momentos bons. Fui me aproximando de você e, a cada hora que passava, me apaixonando mais pelo seu jeito. Foi uma semana agitada, marcando encontros para aproveitar cada minuto antes da sua viagem.' },
  { eyebrow: '30/08/2024', title: 'Dia da Viagem', desc: 'Apareci de surpresa no aeroporto — minha ficha de que ia ficar um tempão sem te ver ainda não tinha caído. Queria só te surpreender com um bichinho de pelúcia e uns chocolates. Lembro do seu pai cheio de ciúmes, da sua mãe desconfiada e de todo mundo surpreso ao nos ver juntos. E de quando a gente prometeu se esperar até a sua volta.' },
  ...
  { eyebrow: '12/06/2026', title: 'Primeiro Dia dos Namorados', desc: 'Nosso primeiro Dia dos Namorados juntos. Cada day ao seu side é um misto de emoções que mal consigo descrever — e esse foi o primeiro de muitos outros que ainda estão por vir. Sempre vou me dedicar ao máximo para te proporcionar tudo o que você merece.' },
